...
def collect_data():
    def gather_20newgroup_data():
        path = 'Session 1\TF-IDF Vectorizer\\20news-bydate'
    ...
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\stopwords.txt') as f:
    ...
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\\20news-train-processed.txt', 'w') as f:
        f.write('\n'.join(train_data))
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\\20news-test-processed.txt', 'w') as f:
        f.write('\n'.join(test_data))
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\\20news-full-processed.txt', 'w') as f:
        f.write('\n'.join(full_data))
...
def generate_vocabulary(data_path):
    ...
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\words_idfs.txt', 'w') as f:
...
def get_tf_idf(data_path):
    ...
    with open('Session 1\TF-IDF Vectorizer\\20news-bydate\\train_tf-idf.txt', 'w') as f:
        f.write('\n'.join([str(label) + '<fff>' + str(doc_id) + '<fff>' + sparse_rep for (label, doc_id, sparse_rep) in data_tf_idf]))

if __name__=="__main__":
    collect_data()
    print('Finish collecting data!')
    generate_vocabulary('Session 1\TF-IDF Vectorizer\\20news-bydate\\20news-full-processed.txt')
    print('Finish generating vocabulary!')
    # get_tf_idf('Session 1\TF-IDF Vectorizer\\20news-bydate\\20news-train-processed.txt')
